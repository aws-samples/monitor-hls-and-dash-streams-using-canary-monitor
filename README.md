...
|---------|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|------|
| Default | Stale manifest                        | Occurs when manifest contains no new segments in last 20 seconds                                                                                                                                                                                                                | Playback    | 101  |
| Default | Last segment not found                | Occurs when last known segment is not found in the most recent manifest, e.g. the manifest goes backwards. This can happen when manifests are cached for too long.                                                                                                              | Playback    | 102  |
| Default | Discontinuity                         | Occurs when EXT-X-DISCONTINUITY is found in an HLS manifest. Occurs when "t" value of segment n + 1 does not equal "t" + "d" value of segment n and segments are in the same DASH manifest period.                                                                              | Playback    | 103  |
| Default | Change in multivariant manfiest       | Occurs when HLS multivariant manifest has changed                                                                                                                                                                                                                               | Playback    | 104  |
| Default | Missing availabilityStartTime         | Occurs when availabilityStartTime is missing in DASH manifest                                                                                                                                                                                                                   | Playback    | 105  |
| Default | Active input change                   | Occurs when AWS MediaPackage active input changes from one pipeline to another based on "X-Amzn-Mediapackage-Active-Input" header values                                                                                                                                        | Playback    | 106  |
| Default | Endpoint change                       | Occurs when AWS MediaPackage endpoint changes as result of CDN origin failover based on "CMSD-Static" header values                                                                                                                                                             | Playback    | 107  |       
| Default | Back to back ad break                 | Occurs when a new ad break starts while another ad break is in progress                                                                                                                                                                                                         | Advertising | 108  |
| Default | Multiple segmentation descriptors     | Occurs when manifest ad break decoration contains multiple segmentation descriptors, which can lead to a failure to detect an ad break opportunity                                                                                                                              | Advertising | 109  |
| Custom  | Segment availability in future        | Occurs when a DASH segment availability time computed as availabilityStartTime + period start + (t – presentationTimeOffset) / timescale is more than "maxfuturesegmentavailability" seconds in the future when compared with the wall clock time of when manifest was received | Playback    | 201  |
| Custom  | Missing rendition                     | Occurs when a rendition listed in "requiredrenditions" is missing                                                                                                                                                                                                               | Playback    | 202  |
| Custom  | Ad break duration delta               | Occurs when the sum of segment durations between ad break start and end does not match the advertised ad break duration +- value in "maxadbreakdurationdelta". This can happen when an ad break is cut short early or when the manifest ad break decorations are incorrect.     | Advertising | 203  |
| Custom  | Ad break without advertised duration  | Occurs when an ad break is advertised without duration and "checkadbreakscteduration" is set                                                                                                                                                                                    | Advertising | 204  |
| Custom  | Unexpected ad break start SCTE signal | Occurs when an ad break start manifest decoration is found, but the SCTE message type is not in the "adbreaksctesignals" list                                                                                                                                                   | Advertising | 205  |

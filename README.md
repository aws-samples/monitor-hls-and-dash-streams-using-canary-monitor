...
| Custom | Unexpected ad break start SCTE signal | Occurs when an ad break start manifest decoration is found, but the SCTE message type is not in the "adbreaksctesignals" list                                                                                                                                                   | Advertising | A005 |

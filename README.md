...
| Playback    | LAST_SEGMENT_NOT_FOUND            | Occurs when last known segment is not found in the most recent manifest, e.g. the manifest goes backwards. This can happen when manifests are cached for longer than is the request time between manifests.                                                                            |

...
| Manifests | PdtDelta           |                                | Difference between program date time of the last segment and current wall clock time. Published only when EXT-X-PROGRAM-DATE-TIME is present in HLS manifest and the metric represents the following calculation: EXT-X-PROGRAM-DATE-TIME of last segment - current wall clock time. |
